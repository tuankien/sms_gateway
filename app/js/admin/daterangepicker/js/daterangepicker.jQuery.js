...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			{text: LANG.TEXT_TODAY, dateStart: 'today', dateEnd: 'today' },
			{text: LANG.TEXT_LAST7DAYS, dateStart: 'today-7days', dateEnd: 'today' },
			{text: LANG.TEXT_MONTHTODATE, dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: LANG.TEXT_YEARTODATE, dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
			{text: LANG.TEXT_PREVMONTH, dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
		...
		presets: {
			specificDate: LANG.TEXT_SPECDATE,
//			allDatesBefore: 'Tất cả Ngày Trước ngày hiện tại',
//			allDatesAfter: 'Tất cả Ngày Sau ngày hiện tại',
			dateRange: LANG.TEXT_DATERANGE
		},
		rangeStartTitle: LANG.TEXT_STARTDATE,
		rangeEndTitle: LANG.TEXT_ENDDATE,
		nextLinkText: LANG.TEXT_NEXT,
		prevLinkText: LANG.TEXT_PREV,
		doneButtonText: LANG.TEXT_DONE,
	...
	var rpPresets = (function(){
        //anhpt modify
        var clearField = '<li class="ui-corner-all clearData" onclick="$(\'.'+rangeInput.attr('class')+'\').val(\'\');$(\'.ui-daterangepicker\').data(\'state\', \'closed\');$(\'.ui-daterangepicker\').fadeOut(300);"><a href="#">'+LANG.TEXT_CLEAR+'</a></li>';
		var ul = jQuery('<ul class="ui-widget-content">'+clearField+'</ul>').appendTo(rp);
        //end modify
	...
	jQuery.fn.clickActions = function(rp, rpPickers, doneBtn){
        //anhpt modify
		if(this.hasClass('clearData')) return false;
        //end modify
