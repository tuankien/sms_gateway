...
<div class="wide form">
    ...
    <table>
        ...
        <tr>
            <td class="alignRight"><?php echo Yii::t('BackEnd','sender'); ?></td>
            <td><?php echo $form->textField($model,'sender',array('size'=>20,'maxlength'=>20)); ?></td>
        ...
        <tr>
            ...
            <td><?php echo $form->textField($model,'content',array('size'=>40,'maxlength'=>255)); ?></td>
            <td class="alignRight"><?php echo Yii::t('BackEnd','Keyword'); ?></td>
            <td><?php echo $form->textField($model,'keyword',array('size'=>20,'maxlength'=>255)); ?></td>
        </tr>
        <tr>
